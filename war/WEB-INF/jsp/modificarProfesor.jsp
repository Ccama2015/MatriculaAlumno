...
<script type="text/javascript" src="js/jquery.js"></script>
	...
	<script type="text/javascript" src="js/modificarProfesor.js"></script>
...
<div id="bg">
		<div class="wrap">
			...
			<div id="main">
				 <div id="cuerpo" >
                   <a style=" font-family: Calibri; font-size: 40px ">MODIFICAR DATOS DEL DOCENTE</a><br>
                 </div><br>
	
				<!-- bits -->
				<div id="x">
		<form id="modificarProfesor" action="modificarProfesor"  method="post">
		<label>INGRESE SU DNI:</label><input type="text" id="DNI" name="DNI"><br><br>
		...
		<select name="dato">
							...
							<div class="etiqueta">
								<option value="GradoAcademico">Grado Academico</option>
							</div>
							<div class="etiqueta">
								<option value="DepartamentoAcademico">Departamento Academico</option>
							</div>
							</select>
				<br><br>
