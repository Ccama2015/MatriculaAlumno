...
<div id="bg">
		<div class="wrap">
			...
			<div id="main">
				...
				<!-- bits -->
				<div id="x">
		<form id="modificarCurso" action="modificarCurso"  method="post">
		<label>CODIGO: </label><input type="number" id="codigo" name="codigo"><br><br>
		<label>SELECCIONE</label>
		<select name="dato">

							<div class="etiqueta">
								<option value="nomcurso">Nombre del Curso</option>
							</div>
							<div class="etiqueta">
								<option value="creditos">Creditos</option>
							</div>
							<div class="etiqueta">
								<option value="deptacademico">Departamento Academico</option>
							</div>
							<div class="etiqueta">
