...
<div id="bg">
		<div class="wrap">
			...
			<div id="main">
				 <div id="cuerpo" >
                   <a style=" font-family: Calibri; font-size: 40px ">LISTA DE DOCENTES</a><br>
                 </div><br>
		...
		<% List<Profesor> profe = (List<Profesor>) request.getAttribute("profe");%>
		<%for( Profesor p : profe ) {%>
				<tr>
						...
						<td><%=p.getDistrito() %> </td>
						<td><%=p.getTelefono() %></td>
						<td><%=p.getGradoAcademico() %></td>
						<td><%=p.getDepartamentoAcademico() %></td>
					</tr>
