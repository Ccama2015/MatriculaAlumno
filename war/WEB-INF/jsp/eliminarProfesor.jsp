...
<script type="text/javascript" src="js/jquery.js"></script>
	...
	<script type="text/javascript" src="js/eliminarProfesor.js"></script>
...
<div id="bg">
		<div class="wrap">
			...
			<div id="main">
				 <div id="cuerpo" >
                   <a style=" font-family: Calibri; font-size: 40px ">ELIMINAR DATOS DEL DOCENTE</a><br>
                 </div><br>
	
				<!-- bits -->
				<div id="x">
<form id="eliminarProfesor" action="eliminarProfesor" method="post">
<label>DNI: </label>
