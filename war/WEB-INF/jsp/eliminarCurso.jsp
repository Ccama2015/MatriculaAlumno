...
<script type="text/javascript" src="js/jquery.js"></script>
	...
	<script type="text/javascript" src="js/eliminarCurso.js"></script>
...
<div id="bg">
		<div class="wrap">
			...
			<div id="main">
				 <div id="cuerpo" >
                   <a style=" font-family: Calibri; font-size: 40px ">ELIMINAR CURSO</a><br>
                 </div><br>
	
				<!-- bits -->
				<div id="x">
			 <form action="eliminarCurso" id="eliminarCurso" method="post">
                <label>CODIGO</label><br>
                <input type="number" id="codigo" name="codigo">
                <input type="submit" id="eliminarCurso" value="ELIMINAR">
             </form>
             </div>
				<!-- /bits -->
